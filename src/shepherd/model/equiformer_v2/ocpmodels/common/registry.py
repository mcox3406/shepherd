...
def _get_absolute_mapping(name: str):
    ...
    # e.g., `shepherd.model.equiformer_v2.ocpmodels.tasks.base_task.BaseTask`
    # we can use importlib to get the module (e.g., `shepherd.model.equiformer_v2.ocpmodels.tasks.base_task`)
...
class Registry:
    ...
    def register_task(cls, name):
        ...
        Usage::
            from shepherd.model.equiformer_v2.ocpmodels.common.registry import registry
            from shepherd.model.equiformer_v2.ocpmodels.tasks import BaseTask
    ...
    def register_dataset(cls, name):
        ...
        Usage::
            ...
            from shepherd.model.equiformer_v2.ocpmodels.common.registry import registry
            from shepherd.model.equiformer_v2.ocpmodels.datasets import BaseDataset
    ...
    def register_model(cls, name):
        ...
        Usage::
            ...
            from shepherd.model.equiformer_v2.ocpmodels.common.registry import registry
            from shepherd.model.equiformer_v2.ocpmodels.modules.layers import CGCNNConv
    ...
    def register_logger(cls, name):
        ...
        def wrap(func):
            from shepherd.model.equiformer_v2.ocpmodels.common.logger import Logger
    ...
    def __import_error(cls, name: str, mapping_name: str):
        ...
        if existing_cls_path is not None:
            ...
            existing_cls_path = "shepherd.model.equiformer_v2.ocpmodels.trainers.ForcesTrainer"
