...
def run_inference_scaling_test(args):
    ...
    if args.start_step <= 1:
        ...
        if baseline_results is None:
            ...
            try:
                ...
                save_results(baseline_results, output_dir, "baseline_results.pkl")
            except Exception as e:
    ...
    num_steps = 2 if args.fast else 5
    ...
    if args.start_step <= 2:
        ...
        if random_search_results is None:
            ...
            save_results(random_search_results, output_dir, "random_search_results.pkl")
        else:
    ...
    if args.start_step <= 3:
        ...
        if zo_search_results is None:
            ...
            save_results(zo_search_results, output_dir, "zo_search_results.pkl")
        else:
